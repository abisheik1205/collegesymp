            ...
            <div className="departmentsInGridEach">
                ...
                <div className="departmentsInGridEachStackContentBG" onMouseOver={handleOver} onj onMouseOut={handleOut}>
                    <div className={hover? "departmentsInGridEachStackContent": "departmentsInGridEachStackContentHide"} >
                        <p className="departmentsInGridEachStackContentPara"><Fade>The stage's heating up, so get your spirits ignited, as it's time for you to put on a costume of confidence and swagger your moves with your crew. Prepare to leave a mark on the dance floor.</Fade></p>
                    </div>
