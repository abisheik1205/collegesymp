                        ...
                        <div key={key}>
                            {
                                ...
                                <AllDepartmentPageEachContainer link="eventpage" entertainmentPic={item.entertainmentPhoto} departmentMotto={item} image={item.image} eventName={item.eventName} departmentName={item.departmentName} eventdescription={item.description} textLink={item.textLink} theme={item.theme} shortDescription={item.shortDescription} snap={item}/>
                            </Fade> : <Fade slow right>
                                <AllDepartmentPageEachContainer link="eventpage" departmentMotto={item} image={item.image} entertainmentPic={item.entertainmentPhoto} eventName={item.eventName} departmentName={item.departmentName} eventdescription={item.description} textLink={item.textLink} theme={item.theme} shortDescription={item.shortDescription} snap={item}/>
                            </Fade>
                            }
